 ...
 */
final class Version20230211152947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recherche (id INT AUTO_INCREMENT NOT NULL, nom_prestataire VARCHAR(255) DEFAULT NULL, nom_categorie VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
